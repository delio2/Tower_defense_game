...
- In calo: **Strategia -4%** (dominata dai 4X grandi), **RPG -14%**.
- I giochi minimal sono in cima: **Block Blast** è il gioco più scaricato al mondo (2024, 2025, primo trimestre 2026; 870M download).
  **Arrows – Puzzle Escape** è una categoria nata nel 2026, già #4 nei download.
- Meccaniche di moda: minigiochi di esplorazione a energia, battle pass con gacha, album di collezionabili, roguelite.

## Pubblico
- Età media del giocatore mobile **36 anni**. Fasce: 25–34 (29,5%), 16–24 (28,3%), 35–44 (23,1%). Genere circa 50/50.
- Gli uomini preferiscono strategia e sport; le donne puzzle, e il **75% gioca per rilassarsi**.
- **Target scelto: adulti 18–45, pubblico misto.** Nessun gioco per bambini.

## Perché NON i giochi per bambini
- Families Policy di Google Play: niente pubblicità personalizzata, niente identificativi pubblicitari, solo SDK certificati (il programma non accetta nuovi ingressi).
- Guadagno per annuncio **da 2,5 a 5+ volte più basso**. AppLovin MAX blocca i minori di 13 anni; ironSource Direct ha chiuso ad aprile 2026.
- Nuove leggi sull'età (Louisiana 2026, California e Utah 2027, Online Safety Act nel Regno Unito).
- ⚠️ Uno stile **infantile** può far classificare il gioco "per bambini" anche se dichiari un pubblico adulto. Lo stile deve essere carino o elegante, **mai infantile**.

## Economia (Google Play, sviluppatore singolo)
| Metrica | Valore 2026 |
|---|---|
| eCPM rewarded, Paesi ricchi | le fonti non concordano: 15–30 $ (stime generali) contro circa 13 $ misurati su Android USA → **per i calcoli usiamo 10–15 $** |
| eCPM interstitial, Paesi ricchi | 5–8 $ |
| ARPDAU ibrido (pubblicità + acquisti) | 0,15–0,50 $ |
| Retention mediana D1 / D7 / D30 | 22% / <4% / 0,8% |
| CPI Android, Paesi ricchi | circa 3 $ (midcore 3–10 $) |
| Commissione Google sugli acquisti | 15% fino a 1M $ l'anno (bisogna **iscriversi** al programma sulla Play Console) |
| Installazioni dalla ricerca nello store | 50–70% |

- Valore per download *(stima)*: debole 0,05–0,15 $, discreto 0,30–0,60 $, buono 1–2 $.
- Obiettivo realistico *(stima)*: 10k–100k download nel primo anno con promozione costante.
- **Nuovo account personale**: test chiuso obbligatorio con **12 tester per 14 giorni**, poi circa 7 giorni di revisione.

## Tower defense: cosa criticano i giocatori
| Gioco | Critiche |
|---|---|
| Kingdom Rush 5 (mobile) | Paghi il gioco e ottieni circa metà dei contenuti. Eroi e torri costano quanto il gioco. Su Steam è completo |
| Bloons TD 6 | Monkey Knowledge diventato un grind a pagamento di valuta |
| Rush Royale / Random Dice | Pay-to-win, matchmaking contro giocatori 2 volte più forti, troppa casualità, co-op senza vedere il compagno |
| PvZ 2 / 3 | Piante a pagamento; PvZ3 semplificato, formazioni imposte, meno libertà |
| Infinitode 2 | Grind arbitrario nella fase avanzata, telefono acceso di notte |
| Arknights | Energia ("Sanity") che limita il gioco |
| The Tower | Enorme successo economico ma voto 4,0, segno di scontento |

Problemi comuni al genere: **passività** (guardare e aspettare), **ripetitività**, timer ed energia, **casualità ingiusta**, **informazioni scarse**.

## Tower defense: cosa amano i giocatori
| Gioco | Cosa piace |
|---|---|
| Bloons TD 6 | 3 percorsi di potenziamento per torre, eroi, aggiornamenti e bilanciamenti costanti, co-op |
| Kingdom Rush | Livelli fatti a mano, eroi da muovere, fascino |
| Arknights | L'abilità conta più dei soldi, abilità attive, roguelike senza energia, ripetizione automatica |
| Thronefall | Minimal, ciclo giorno/notte, **zero microtransazioni**; 1–3 persone, 315k copie, circa 1,5M $ |
| Gnomes | Roguelike con labirinti; **2 sviluppatori, 10 mesi**, oltre 360k $ |
| Infinitode 2 / Mini TD 2 | Minimal, profondo, onesto; Mini TD 2 fatto da **1 sviluppatore** |
| The Tower | Numeri che crescono, minimal; circa 1M $ al mese (stima di terze parti) |

## Cosa chiede la community e non trova
Tower defense ibrido (roguelite / city-builder / azione) · monetizzazione onesta · **sinergie ed effetti di stato** · più modalità in un gioco ·
co-op e social asincrono · salvataggio nel cloud e multipiattaforma · QoL completa (velocità, pausa, anteprima ondate) ·
**"cozy mobile ma con strategia profonda"** · un tower defense moderno "di riferimento".

## Concorrenti diretti sull'originalità (da tenere d'occhio)
- **Emberward**, **Refactor**: tower defense roguelite con labirinti a blocchi Tetris, anche su mobile. → Il "labirinto a blocchi" non è originale.
- **Rhythm Towers** (PC/console), **Bass Defense**, **TowerBeats** (itch.io): tower defense musicali. → **Nessun titolo affermato su mobile.**
...
- Demografia: https://www.blog.udonis.co/mobile-marketing/mobile-games/modern-mobile-gamer
...
- 12 tester / 14 giorni: https://support.google.com/googleplay/android-developer/answer/14151465?hl=en
