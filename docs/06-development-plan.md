...
**Status (2026-09-22):** Phase 0 ✅ · Phase 1 ✅ (Gate 1 with testers pending) · Phase 2 ✅ in code (Gate 2 with testers pending) · **Phase 2.5 🔄** (design ✅; foundations A1–A7 ✅ except the device checks of A3/A4; slices **B, C, D ✅**; E1 build ✅ on a Pixel 10, E2 ✅; the quality-level split and E3 testers left) · Phase 3 ⬜ (waits for approval of `11`–`12`). 47 automated tests, balance `0.3.0`.
